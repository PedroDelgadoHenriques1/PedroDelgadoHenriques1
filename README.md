...
Software Engineer (UniSenaiPR). Started in full-stack web — PHP, Magento, e-commerce — and moved toward heavier stacks. Until recently my daily work was **pure C++** on a proprietary engine, modeling slot machine math at **Firepot Gaming**.
...
- 🎮 **Most recent:** C++ Game Developer @ [Firepot Gaming](https://www.firepotgaming.com/slots) — slots on a proprietary engine, RNG, RTP/volatility modeling
...
Engenheiro de Software formado pela **UniSenaiPR**. Comecei no full-stack web — PHP, Magento, e-commerce — e fui migrando pra stacks mais pesados. Até recentemente meu dia a dia era **C++ puro** em engine proprietária, modelando matemática de slot machines na **Firepot Gaming**.
...
- 🎮 **Mais recente:** Desenvolvedor de Jogos C++ @ [Firepot Gaming](https://www.firepotgaming.com/slots) — slots em engine proprietária, RNG, modelagem de RTP/volatilidade
